...
def telegram_input(asm):
    ...
    def _build_menu(cfg, pending):
        """
        Returns (text, InlineKeyboardMarkup) for the main menu.
        """
        ...
        rows = []
        # two‐per‐row for keys
        for i in range(0, len(key_btns), 2):
            rows.append(key_btns[i : i + 2])
